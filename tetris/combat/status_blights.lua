...
function StatusBlights.getDASOffset(board)
    if board and board.blights and board.blights.frostbite.active then
        return 0.060 -- +60ms de retraso por congelación
    end
    return 0.0
end
...
function StatusBlights.getARROffset(board)
    if board and board.blights and board.blights.frostbite.active then
        return 0.015 -- +15ms de lentitud por congelación
    end
    return 0.0
end
...
function StatusBlights.onPlayerLineClear(board, cleared_count, is_tspin)
    ...
    -- Limpiar líneas reduce y cauteriza estados
...
function StatusBlights.update(board, dt)
    ...
    -- 3. Actualización de Corruption (Deriva Magnética)
...
-- ============================================================================
-- 🎨 RENDERIZADO DE AURAS Y ESCARCHA DE ESTADOS ALTERADOS
-- ============================================================================
